...
export const CITIES: City[] = [
  ...
  { code: 'REK', name: 'Reykjavík', country: 'Iceland', flag: '🇮🇸', lat: 64.15, lon: -21.94, hub: 1.05, hotelNight: 200, foodDay: 95, vibes: ['nature', 'hot springs', 'views'], blurb: 'Halfway point between Europe and North America, with lava fields thrown in.' },
  ...
  { code: 'MSY', name: 'New Orleans', country: 'United States', flag: '🇺🇸', lat: 29.95, lon: -90.07, hub: 1.0, hotelNight: 180, foodDay: 80, vibes: ['music', 'food', 'nightlife'], blurb: 'Jazz, gumbo and go-cups — America’s best city for a group weekend.' },
  ...
  { code: 'RAK', name: 'Marrakesh', country: 'Morocco', flag: '🇲🇦', lat: 31.63, lon: -7.99, hub: 1.02, hotelNight: 90, foodDay: 40, vibes: ['souqs', 'food', 'desert'], blurb: 'Riads, mint tea and the Atlas mountains on the horizon.' },
  ...
  { code: 'DPS', name: 'Bali (Denpasar)', country: 'Indonesia', flag: '🇮🇩', lat: -8.65, lon: 115.22, hub: 1.0, hotelNight: 90, foodDay: 35, vibes: ['beach', 'nature', 'wellness'], blurb: 'Rice terraces, surf and villas that make group travel cheap and easy.' },
